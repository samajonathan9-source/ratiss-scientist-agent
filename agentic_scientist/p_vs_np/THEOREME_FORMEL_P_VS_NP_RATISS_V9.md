...
*Preuve.*  
En assemblant l'inclusion quantique et le Lemme 4.1 :
...
Si $D = \text{poly}(N)$, l'approximation classique locale est polynomiale. Pour séparer formellement $\mathbf{P}$ et $\mathbf{NP}$, il est donc indispensable de démontrer la dureté inhérente de l'approximation de l'invariant topologique lui-même.
